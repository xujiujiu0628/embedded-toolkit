...
- **F-177 (fix, capture): uart 采集在 CH340/CP210x 桥接板上 0 行——开口即释放 DTR/RTS (2026-09-19 凌晨, 初代 esp32 补票真机钓出)**:
  ...
  测试: 执行序钉(open→dtr=False→rts=False→首 readline, 撤旧代码红/新代码
...
- **GAP-F-20 登记（维护者裁定 2026-09-26, docs）**: F-191 P 面 P-1（共享向量 TIM 的
  ISR 名生成——仅 TIM1 特判, TIM9/12/13/14 生成名非 CMSIS 实名, F-086 同族 B 类静默;
...
## Unreleased — 2026-09-26（WB-05 残量入册 + GAP-F-13 口径订正，docs；对账=WB-20260926-04）

- **docs (WB-20260926-04 采纳)**: WB-05 审查残量三态对账收官——范围内 21 条 →
  已修 4（M-2/M-3/M-10/M-11/N-4 等随 F-178/191/192 销账）· 仍在 17 · 变异 0。
  经维护者批准，README 已知遗落入册两个打包条目 + Note 声明（含同号异病防呆前缀
  纪律）；GAP-F-13 计数现势口径统一为 test_stub_ratchet BASELINE（73 键/157 处/
  38 文件），98/22 与 102/23 退役史料。F-178"已闭合"账经两枚反演抽验非口头。
...
- **GAP-F-21 登记（维护者裁定 2026-09-26, docs）**: F-193 P 面两面同册入账——
