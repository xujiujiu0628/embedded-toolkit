...
/* ========================================================================
 * ADC1 CH0 — PA0 (single conversion, 12-bit)
 * ======================================================================== */
...
ADC1->SMPR2 |= (5UL << 0);  // CH0: 55.5 cycles
ADC1->SQR3 = 0;                 // 转换序列: 1 个通道 = CH0
ADC1->CR2 = 1;                    // ADON 上电
